...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to SavraSchool</h1>
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>SavraSchool provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>SavraSchool Pvt Ltd <br> Near Police Camp II <br> jalandhar punjab (144001) <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
